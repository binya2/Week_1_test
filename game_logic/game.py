...
def war(p1:dict,p2:dict):
    ...
    while len(p1["hand"]) > 4 and len(p2["hand"]) > 4:
        p1_cards.append(p1["hand"].pop(0))
        p1_cards.append(p1["hand"].pop(0))
        p1_cards.append(p1["hand"].pop(0))
        p1_cards.append(p1["hand"].pop(0))

        p2_cards.append(p2["hand"].pop(0))
        p2_cards.append(p2["hand"].pop(0))
        p2_cards.append(p2["hand"].pop(0))
        p2_cards.append(p2["hand"].pop(0))
        print(f"{p1['name']}'s fourth card:{p1_cards[-1]['value']} vs {p2['name']}'s fourth card:{p2_cards[-1]['value']}", end=" = ")
